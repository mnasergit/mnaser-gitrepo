...
if lab_name_check not in existing_labs:
    ...
    def create_node(ios_num, slax_num):
        ...
        for i in range(1, ios_num + 1):
            ...
            if create_node_api:
                print(f"IOS node Group{i}-Router1 created.")
            else:
        ...
        for j in range(1, slax_num + 1):
            ...
            if create_node_api:
                print(f"SLAX node Group{j}-Host1 created")
            else:
    ...
    for i in range(1, num_slax + 1):
        ...
        if create_bridge_api:
            print(f"Bridge network{i} created")
        else:
    ...
    for i in range (1, num_ios + 1):
        ...
        if add_intf_api:
            print(f"IOS node Group{i}-Router1 connected to Bridge network{i}")
        else:
    ...
    for i in range (num_ios + 1, num_ios + num_slax + 1):
        ...
        if add_intf_api:
            print(f"SLAX node Group{i}-Host1 connected to Bridge network{j}")
        else:
            print(f"SLAX node Group{i}-Host1 couldn't connected to Bridge network{j}")
    ...
    for i in range (1, num_ios + 1):
        ...
        if add_mgmt_api:
            print(f"IOS node Group{i}-Router1 connected to MGMT network")
        else:
    ...
    print ("Lab name confilcts with existing one.")