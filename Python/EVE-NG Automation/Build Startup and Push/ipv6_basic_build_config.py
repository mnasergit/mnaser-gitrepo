        ...
        if num_group > 0 and  num_group <= 20:
            ...
            def update_task1_config(config_task1_text):
                ...
                for line in lines:
                    if line.strip().startswith("hostname"):
                        replace_flag = True
                        new_task1_config += "hostname " + hostname + "\n"
                        new_task1_config += "!\n"
                    elif line.strip().startswith("interface FastEthernet0/0"):
                        replace_flag = True
            ...
            try:
                ...
                for i in range(2, num_group + 2):
                    ...
                    with open(f"ipv6_basic_out_files/{hostname}-startup-config.txt", 'w') as write_cfg:
                        write_cfg.seek(0)
                    ...
                    with open("ipv6_basic_out_files/Group1-Router1-startup-config.txt", 'r') as start_cfg:
