...
def find_node_type(file_name, read_unl_dict):
    ...
    for item in range(0, len(nodes)):
        ...
        dynamips(node_id, node_name, node_type, node_template, interfaces, node_ip_config, 
...
################################################################################################
def dynamips(node_id, node_name, node_type, node_template, interfaces, node_ip_config,
             read_unl_dict, node_pair, node_commands, supported_node_templates):
